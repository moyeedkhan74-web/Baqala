        ...
        <MagneticHover damping={20} stiffness={100} className="relative p-8 md:p-12 rounded-3xl glass-panel overflow-hidden group border-dark-200/50 dark:border-white/20">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left min-w-0">
              <h2 className="text-2xl sm:text-4xl md:text-5xl font-extrabold text-dark-900 dark:text-white mb-2 tracking-tight transition-colors duration-300 truncate">
                {app.title}
              </h2>
